...
```{r}
results <- evaluate_model(model_1, crimetesting, target_col = "target", model_name = "Model #1")
cm_1 <- results$cm

results <- evaluate_model(model_stepAIC, crimetesting, target_col = "target", model_name = "Model #2")
cm_2 <- results$cm
