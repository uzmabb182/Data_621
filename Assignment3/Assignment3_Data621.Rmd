...
Model 1	0.938	  0.934	    0.939	  0.937	    0.9782
...
Highest Accuracy (0.938) → It makes the fewest classification errors.
Highest F1 Score (0.937) → It balances precision and recall effectively.
Highest AUC (0.9782) → It has the best ability to distinguish between classes
...
F1 Score of 0.937 means that model balances Precision and Recall very well.
