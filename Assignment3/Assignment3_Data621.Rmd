...
stats <- LRstats(model1, model2, model3)
...
enhanceEvaluationMetrics <- function(df, model_name) {
  ...
  } else if (model_name != "model1" & model_name != "model2" & model_name != "model3") {
  ...
  conf_matrix <- confusionMatrix(as.factor(pred_probs_factor), as.factor(model_data$target))
