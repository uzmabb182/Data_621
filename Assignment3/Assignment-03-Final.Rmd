...
author: "Marco Castro, Mubashira Qari, Puja Roy, Zach Rose & Erick Hadi"
date: "2025-03-07"
output:
...
### Alternate Transformation (Mubashira)
...
#### Zach Model 1: Baseline Predictions
...
#### Zach  Model 2: Log-Transformed Predictors
...
```{r}
zr_model_b <- glm(target ~ zr_log_tax + zr_log_dis + zr_log_zn + zr_log_lstat + nox + rm + ptratio + rad + chas + age,
                  data = crime_training_zr, family = binomial)
```


#### Zach  Model 3: Binned Variables Logistic Regression
...
stats <- LRstats(model_full, model_pca, model_dendo, model1, model2, model3, pj_model1, pj_model2, pj_model3, zr_model_a, zr_model_b, zr_model_c)
