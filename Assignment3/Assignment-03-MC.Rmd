...
stats$mcfaddenR2 <- NA 
stats["model_full", "mcfaddenR2"] <-  pR2(model_full)["McFadden"]
stats["model_full_log", "mcfaddenR2"] <-  pR2(model_full_log)["McFadden"]
stats["backward_model", "mcfaddenR2"] <-  pR2(backward_model)["McFadden"]
stats["model_corr", "mcfaddenR2"] <-  pR2(model_corr)["McFadden"]
stats["model_pca", "mcfaddenR2"] <-  pR2(model_pca)["McFadden"]
stats["model_dendo", "mcfaddenR2"] <-  pR2(model_dendo)["McFadden"]
