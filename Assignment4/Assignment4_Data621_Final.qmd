...
author: "Puja Roy, Mubashira Qari, Marco Castro, Zach Rose, Erick Hadi"
date: "2025-03-23"
format: pdf
---
...
testing_df_clean$TARGET_FLAG <- prediction
...
predictions_amt <- predict(amt_model3, testing_df_clean)
testing_df_clean$TARGET_AMT <- predictions_amt


head(testing_df_clean)
```
