...
print(model_cv)
```
MAE and RMSE is even lower when using cross-validation. Although our R-squared value decreased from 0.3183 to 0.3034024, this value is still higher than the next most performant model which had an R-squared value of 0.2368 ().
