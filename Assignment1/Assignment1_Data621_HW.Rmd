...
The Lasso model achieved an MAE of `r lasso_metrics$MAE` which suggests the model has a low average error in predicting TARGET_WINS. The RMSE value of `r 
lasso_metrics$RMSE` supports this conclusion. The R-squared value of `r lasso_metrics$RSquared` indicates that the Lasso model explains a substantial portion of the variance in the TARGET_WINS.
