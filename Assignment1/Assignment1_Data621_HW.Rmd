...
predictedWins = predict(stp_model, stp25_test_df)
...
summary(pred)
```
The summary and diagnostic plot reveals that our model is statistically significant and somewhat linear.
...
_Log Tranformed Model_
Adjusted R-squared:  0.3171


### Model 6: Lasso Regression 

Lasso subset selection uses a shrinkage approach  to 
...
compare_performance(stp_model, stp_model2, stpb_model3, stpb_model4, stpb_model5, stplg_model, lasso_model, rank = TRUE)
```
