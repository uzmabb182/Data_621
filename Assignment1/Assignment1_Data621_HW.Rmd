...
author: "Mubashira Qari, Marco Castro, Puja Roy, Zach Rose"
date: "2025-02-09"
output:
  html_document:
    df_print: paged
...
set.seed(123)
train_index <- createDataPartition(train_data$TARGET_WINS, p = 0.75, list = FALSE)
stp75_train_df <- train_data[train_index, ]
stp25_test_df <- train_data[-train_index, ]

# Initial data exploration
str(stp75_train_df)
summarize(stp75_train_df)
...
stp75_train_df <- stp75_train_df %>% mutate(log_TEAM_BATTING_H = log(TEAM_BATTING_H + 1), log_TEAM_BATTING_HR = log(TEAM_BATTING_HR + 1))
